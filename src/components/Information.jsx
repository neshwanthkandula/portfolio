...
const Information = () => {
  return (
    <div className="px-4 sm:px-10 md:px-20 lg:px-50 mt-32 md:mt-40 flex flex-col md:flex-row items-center md:items-start justify-between gap-10">
      
      {/* Left Content */}
      <div className="md:basis-3/5 flex flex-col gap-10 text-center md:text-left">
        
        {/* Intro Text */}
        <div className="font-bold text-4xl sm:text-5xl md:text-6xl flex flex-col gap-4">
          <div>Hi,</div>
          <div className="flex justify-center md:justify-start">
            <div>I&apos;m</div>
            <div className="pl-2 text-blue-500">Neshwanth</div>
          </div>
        ...
        <div className="flex justify-center md:justify-start">
          <a href="https://drive.google.com/uc?export=download&id=1AKURaIJspfChn7Kfy5rRu7e2NRAwwUPD">
            <button className="bg-blue-500 rounded-xl text-white px-6 py-2 flex items-center hover:bg-blue-700 cursor-pointer">
              Resume
              <div className="pl-2">
                <DOWNLOAD_LOGO />
              </div>
      ...
      {/* Right Photo */}
      <div className="md:basis-2/5 flex justify-center items-end pl-20 md:justify-end">
        <PhotoCard />
      </div>
    </div>
  );
...
export function Linkedin() {
  return (
    ...
    >
      <svg xmlns="#" width="28" height="28" viewBox="0 0 72 72" fill="currentColor">
...
export function Mail() {
  return (
    <a
      ...
      className="p-2 rounded-lg flex items-center justify-center text-gray-900 hover:text-blue-600 transition-colors duration-300"
    >
      <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 72 72" fill="currentColor">
...
export function Github({ Link }) {
  return (
    <a
      ...
      className="p-2 rounded-lg flex items-center justify-center text-gray-900 hover:text-blue-600 transition-colors duration-300"
    >
      <svg xmlns="http://www.w3.org/2000/svg" width="28" height="26" viewBox="0 0 24 24" fill="currentColor">
